# RailsAdmin config file. Generated on December 14, 2013 22:12
...
RailsAdmin.config do |config|
  ...
  config.main_app_name = ['Designer', 'Admin']
  ...
  # config.excluded_models = ['Blog', 'User']

  # Include specific models (exclude the others):
  # config.included_models = ['Blog', 'User']
